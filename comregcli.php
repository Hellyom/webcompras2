  ...
  <?php
    try {
      if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        insertRow($conn, "CLIENTE", ["NIF", "NOMBRE", "APELLIDO", "CP", "DIRECCION", "CIUDAD", "USUARIO", "CONTRASENA"],
                                    [$nif, $name, $surname, $cp, $dir, $city, $user, $pwd]);

        //Create unique token for user and insert into TOKENS table
        insertRow($conn, "TOKENS", ["NIF", "TOKEN"],
                                   [$nif, uniqid()]);
